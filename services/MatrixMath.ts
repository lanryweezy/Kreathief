...
export const MatrixMath = {
     ...
     */
    compose(x: number, y: number, width: number, height: number, rotationDeg: number, pivotX: number = 0.5, pivotY: number = 0.5): Matrix {
     ...
     */
    decompose(m: Matrix, pivotXPct: number = 0.5, pivotYPct: number = 0.5, currentWidth: number, currentHeight: number) {
