...
function style(
  overrides: Partial<DesignStyleEntry> &
    Pick<DesignStyleEntry, 'id' | 'name' | 'category' | 'tagline' | 'description' | 'palette' | 'keywords'>
): DesignStyleEntry {
  return {
    era: '',
    icon: '🎨',
...
export const DESIGN_STYLE_DATABASE: Record<string, DesignStyleEntry> = {
  ...
  artDeco: style({
    ...
    description:
      'Bold geometric shapes, symmetry, metallic accents, stepped forms, and cinematic opulence. Born from the roaring 20s obsession with progress and luxury.',
  ...
  artNouveau: style({
    ...
    description:
      'Nature-inspired flowing lines, whiplash curves, floral ornament, and refined typography. A reaction against industrialization celebrating handcrafted beauty.',
  ...
  baroque: style({
    ...
    description:
      'Swirling ornamentation, intense contrasts, lavish details, and theatrical drama. Originally a Catholic Counter-Reformation power move to inspire awe.',
  ...
  victorian: style({
    ...
    description:
      'Rich colors, intricate details, elaborate floral motifs, ornate serif fonts, damask patterns, and maximalist ornamentation from the British monarchy era.',
    badge: 'GILDED CRAFT',
  ...
  neoclassical: style({
    ...
    description:
      'Greco-Roman ideals of symmetry, order, and elegance. Strategic red accents against muted classical palettes. Structure and reason over ornamentation.',
  ...
  chinoiserie: style({
    ...
    description:
      'Intricate patterns featuring cranes, peonies, bamboo, pagodas, and lattice frames. Porcelain-inspired blue-and-white palettes with craft-forward texture.',
  ...
  filigree: style({
    ...
    description:
      'Delicate ornamentation inspired by vintage jewelry and historical architecture. Lavish swirls, flourishes, and fine details that convey elegance.',
  ...
  bauhaus: style({
    ...
    description:
      'Founded by Walter Gropius. Pure red, yellow, blue, and black. Asymmetric balance, geometric clarity, and the unity of art and craft.',
  ...
  swissStyle: style({
    ...
    description:
      'Strict grid systems, Helvetica, objective photography, asymmetric layouts, and generous white space. The most influential design movement of the 20th century.',
  ...
  minimalism: style({
    ...
    description:
      'Extreme negative space, restrained neutral monochrome, exquisite typography, and absolute focus on essential message.',
  ...
  modernism: style({
    ...
    description:
      'Sans-serif typography, geometric shapes, minimalist grid systems, and contrasting colors. Breaking away from ornamental traditions.',
  ...
  flat: style({
    ...
    description:
      'No shadows, no gradients, no textures. Simple 2D elements, bold colors, clean typography. The language of modern digital interfaces.',
  ...
  geometric: style({
    ...
    description:
      'Order, symmetry, clean edges, and mathematical precision. Creates a sense of logic and innovation through structured shapes.',
  ...
  retroVintage: style({
    ...
    description:
      'Grainy textures, geometric shapes, bold typography, and refined color palettes drawing from 80s-90s aesthetics.',
    badge: 'ANALOG WARMTH',
  ...
  memphis: style({
    ...
    description:
      'Bold geometric shapes, clashing colors, squiggles, and playful patterns. Founded by the Memphis Group (Ettore Sottsass) as a rebellion against minimalism.',
  ...
  y2k: style({
    ...
    description:
      'Chrome/metallic finishes, neon gradients, tech UI overlays, bubble typography, grunge meets gloss, holographic accents. The aesthetic of the millennium.',
  ...
  synthwave: style({
    ...
    description:
      'Grid horizons, VHS textures, neon gradients, 3D chrome type, purple/cyan palettes. The romanticized 80s future that never was.',
    badge: 'NEON DREAMS',
  ...
  vaporwave: style({
    ...
    description:
      'Pastel pinks/purples, VHS glitch, Greek busts, Japanese text, lo-fi textures. A satirical mashup of consumer culture and digital dreams.',
  ...
  popArt: style({
    ...
    description:
      'Ben-Day dots, bold outlines, primary colors, comic-style elements. Blurring the line between commercial art and fine art.',
  ...
  steampunk: style({
    ...
    name: 'Steampunk',
    category: 'retro',
    era: 'Victorian + Sci-Fi',
    icon: '⚙️',
    tagline: 'Victorian aesthetics meet steam-powered fantasy',
    description:
      'Gears, cogs, brass machinery, leather straps, exposed mechanisms. Victorian-era technology reimagined through a speculative lens.',
    badge: 'STEAM & BRASS',
  ...
  midCentury: style({
    ...
    description:
      'Clean lines, retro colors, boomerangs, mod patterns. Form, function, and organic simplicity with warm textures and modern optimism.',
    badge: 'ATOMIC AGE',
  ...
  rocketpunk: style({
    ...
    name: 'Rocketpunk',
    category: 'retro',
    era: '1950s Retrofuturism',
    icon: '🚀',
    tagline: 'The future as the 1950s imagined it',
    description:
      'Rockets, ray guns, atomic symbols, mid-century curves, bold signage typography. Optimistic, sleek, and proudly science-forward.',
    badge: 'SPACE AGE',
  ...
  pixelArt: style({
    ...
    description:
      'Grid-based visuals, limited color palettes, 8-bit/16-bit aesthetics. Born from technical limitations, now a beloved art form.',
    badge: '8-BIT CHARM',
  ...
  brutalism: style({
    ...
    description:
      'Stark layouts, monochrome palettes, unrefined typography, monospaced fonts. Intentionally breaking conventions to make a bold statement.',
    badge: 'RAW CONCRETE',
  ...
  punkGrunge: style({
    ...
    description:
      'Rough textures, muted earth tones, handwritten typography, distorted imagery. DIY aesthetic from the Seattle music scene.',
    badge: 'DIY RAW',
  ...
  graffiti: style({
    ...
    description:
      'Spray paint textures, dripping letters, concrete backgrounds, vivid colors, freestyle typography. Rooted in hip hop culture and protest.',
    badge: 'STREET VOICE',
  ...
  kitsch: style({
    ...
    description:
      'Bright colors, exaggerated imagery, playful pop culture references, irony and nostalgia. Turning tackiness into intentional design.',
    badge: 'IRONIC EXCESS',
  ...
  antiDesign: style({
    ...
    description:
      'Multiple clashing fonts, altered spacing, sideways composition, organized chaos. Intentionally breaking conventions to create something unique.',
    badge: 'RULE BREAKER',
  ...
  gothic: style({
    ...
    description:
      'Dramatic contrast between darkness and grandeur, pointed arches, blackletter fonts, stained glass textures, ornate lettering.',
    badge: 'DARK MAJESTY',
  ...
  tenebrism: style({
    ...
    description:
      'Extreme contrast between light and dark, dramatic spotlight effect, theatrical intensity. Named after the Baroque painting technique.',
    badge: 'CHIAROSCURO',
  ...
  cybercore: style({
    ...
    description:
      'Neon lights, glitch effects, code patterns, green/black themes, circuit board motifs, metallic finishes. The aesthetic of the digital underground.',
  ...
  neonNoir: style({
    ...
    description:
      'Red-and-black palettes with neon highlights, blurred motion effects, gritty high-contrast photography, oversized bold typography.',
    badge: 'NEON SHADOW',
  ...
  biomorphic: style({
    ...
    description:
      'Fluid shapes inspired by cells, anatomy, water, and growth patterns. Calm, futuristic, and warm without being playful.',
    badge: 'ORGANIC FLOW',
  ...
  bohemian: style({
    ...
    description:
      'Global influences, layered textures, earthy yet vibrant palettes, mandalas, ethnic prints, script fonts. Laid-back wanderlust energy.',
    badge: 'FREE SPIRIT',
  ...
  japandi: style({
    ...
    description:
      'Light woods, beige/gray palettes, clean sans-serif fonts, natural materials. The perfect fusion of simplicity and warmth.',
    badge: 'SERENE FUSION',
  ...
  cottagecore: style({
    ...
    description:
      'Florals, gingham, wood textures, antique finishes, serif/hand-drawn type. A romanticization of countryside living and slow life.',
  ...
  mysticalWestern: style({
    ...
    description:
      'Cowboy aesthetics fused with celestial/spiritual imagery. Desert landscapes, moonlit nights, cosmic symbols, tarot, leather textures.',
    badge: 'DESERT MYSTIC',
  ...
  wabiSabi: style({
    ...
    name: 'Wabi-Sabi',
    category: 'organic',
    era: 'Japanese Philosophy',
    icon: '🍵',
    tagline: 'Finding beauty in imperfection',
    description:
      'Embracing imperfection and impermanence. Natural textures, asymmetry, subtle beauty, earthy tones, rough pottery textures.',
  ...
  nautical: style({
    ...
    description:
      'Navy and white, anchors, ropes, stripes, brass, serif/stencil fonts. The clean order of coastal living.',
    badge: 'MARITIME',
  ...
  kawaii: style({
    ...
    description:
      'Rounded shapes, pastel colors, cartoon-like characters, blushing cheeks, handwritten type. The culture of cute.',
    badge: 'CUTE CULTURE',
  ...
  coquette: style({
    ...
    description:
      'Baby pinks, pearls, ribbon motifs, dainty serif fonts, heart shapes, lace, bows, soft filters. Sweet, intimate, and personal.',
  ...
  kidcore: style({
    ...
    description:
      'Crayons, stickers, bold colors, simple shapes, naive drawings. Playful, emotional, and intentionally imperfect.',
    badge: 'CHILDHOOD JOY',
  ...
  anthropomorphic: style({
    ...
    description:
      'Animals/objects given human emotions, expressions, and behavior. Expressive, relatable, and easy to remember.',
  ...
  rubberhose: style({
    ...
    description:
      'Bendy noodle-like limbs, simple features, exaggerated motion, oversized gloves, thick outlines. 1920s-30s animation style.',
  ...
  naive: style({
    ...
    description:
      'Uneven shapes, jittery outlines, messy fills. Design done honestly, where personality matters more than polish.',
    badge: 'HUMAN TOUCH',
  ...
  luxuryTypography: style({
    ...
    description:
      'Custom typefaces, elegant scripts, careful ligatures. Typography alone carries the brand identity with timeless authority.',
  ...
  typeCollage: style({
    ...
    description:
      'Typography-first design where type IS the composition. Mixed fonts, weights, sizes, layering, overlap, and cropping for mood and energy.',
    badge: 'TYPE AS ART',
  ...
  glassmorphism: style({
    ...
    description:
      'Semi-transparent overlays, subtle blur effects, depth and dimension, frosted backgrounds with neon tints.',
    badge: 'FROSTED GLASS',
  ...
  aurora: style({
    ...
    description:
      'Flowing iridescent gradients inspired by the aurora borealis. Smooth transitions between purples, pinks, blues, and greens.',
    badge: 'COSMIC GLOW',
  ...
  ethereal: style({
    ...
    description:
      'Soft hues, delicate layering, airy atmosphere, distorted/blurry imagery. Like viewing the world through a dreamy lens.',
    badge: 'DREAMLIKE',
  ...
  bentoGrid: style({
    ...
    description:
      'Clean, orderly layout organizing content into distinct sections with clear separation. Inspired by Japanese bento boxes.',
  ...
  risograph: style({
    ...
    description:
      'Layered spot colors, visible grain, slight misregistration, tactile texture, ink noise. Handmade print personality.',
    badge: 'PRINT TEXTURE',
  ...
  contemporary: style({
    ...
    description:
      'Big bold typography, vibrant contrasting colors, digital + traditional media blend, sustainable and socially conscious.',
    badge: 'NOW',
  ...
  romantasy: style({
    ...
    description:
      'Ornate type, medieval symbols, florals, moons, swords, dramatic lighting. A brand that feels like a story you can step into.',
  ...
  futureMedieval: style({
    ...
    description:
      'Gothic typography, heraldic symbols, manuscript ornament, mythic motifs, stark contrast palettes, gold/metallic accents with digital textures.',
  ...
  darkAcademia: style({
    ...
    description:
      'Gothic academia + mysticism. Candles, spellbooks, antique etchings, black/gold palette, serif calligraphy.',
  ...
  newMaximalism: style({
    ...
    description:
      'Abundance of colors, shapes, patterns. Controlled chaos with vibrant palettes, dynamic compositions, and fearless visual energy.',
  ...
  humanImperfection: style({
    ...
    description:
      'Hand-drawn elements, candid photography, imperfect textures, organic typography. Deliberate pushback against AI-generated slickness.',
    badge: 'HUMAN MADE',
  ...
  microIndustrial: style({
    ...
    description:
      'Barcodes, QR codes, regulatory marks, tiny text blocks, technical documentation layouts as design elements. Credibility through density.',
  ...
  blotchLogo: style({
    id: 'blotchLogo',
    name: 'Blotch / Fluid Logos',
    category: 'trending',
    era: '2025–Present',
    icon: '💧',
    tagline: 'Variable, fluid, melting logo forms',
    description:
      'Logos that look like they are already on the move. Melting, leaking, organic forms that shift, shrink, and expand.',
    badge: 'SHAPE SHIFTER',
  ...
  neoMinimalism: style({
    ...
    description:
      "Minimal doesn't mean boring. Clean layouts paired with bold type, color pops, or intricate micro-details. One strong element takes the spotlight.",
    badge: 'CLEAN BOLD',
...
export function searchStyles(query: string): DesignStyleEntry[] {
  ...
  return Object.values(DESIGN_STYLE_DATABASE).filter(
    (s) =>
      s.keywords.some((k) => fuzzyMatch(q, k)) ||
      s.mood.some((m) => fuzzyMatch(q, m)) ||
      s.bestFor.some((b) => fuzzyMatch(q, b)) ||
      fuzzyMatch(q, s.name) ||
      fuzzyMatch(q, s.description) ||
      fuzzyMatch(q, s.category)
  );
}
 ...
 */
export function getStyleCategoriesWithEntries(): Array<{
  category: StyleCategory;
  meta: (typeof STYLE_CATEGORIES)[StyleCategory];
  styles: DesignStyleEntry[];
}> {
