 ...
 */
export async function searchPhotos(term: string, page = 1, limit = 20): Promise<FreepikSearchResult<FreepikResource>> {
 ...
 */
export async function searchVectors(term: string, page = 1, limit = 20): Promise<FreepikSearchResult<FreepikResource>> {
 ...
 */
export async function searchMockups(term: string, page = 1, limit = 20): Promise<FreepikSearchResult<FreepikResource>> {
 ...
 */
export async function searchIcons(term: string, perPage = 20, page = 1): Promise<FreepikSearchResult<FreepikIcon>> {
