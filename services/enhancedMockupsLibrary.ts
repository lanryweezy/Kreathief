...
export interface MockupDef {
  ...
  isPremium?: boolean;
  description?: string;
  substrateType?: 'fabric' | 'cylindrical' | 'flat' | 'glass' | 'paper' | 'device';
  supportsRecolor?: boolean;
  cylindricalRadius?: number;
  displacementIntensity?: number;
  placementZones?: string[];
  offlineSvg?: string; // procedural SVG for offline fallback
}
...
export const ENHANCED_MOCKUPS: MockupDef[] = [
  // ==================== APPAREL (12 templates) ====================
  {
    ...
    substrateType: 'fabric' as const,
    supportsRecolor: true,
    displacementIntensity: 12,
    placementZones: ['left_chest', 'center_hero', 'oversized_streetwear'],
  },
  {
    id: 'hoodie',
    name: 'Hoodie',
    ...
    substrateType: 'fabric' as const,
    supportsRecolor: true,
    displacementIntensity: 14,
    placementZones: ['center_hero', 'oversized_streetwear'],
  },
  {
    id: 'model_tshirt',
    name: 'Model T-Shirt',
  ...
  },
  {
    ...
    substrateType: 'fabric' as const,
    supportsRecolor: true,
    displacementIntensity: 6,
    placementZones: ['center_hero'],
  },
  {
    id: 'minimal_tshirt',
  ...
  // ==================== PACKAGING (10 templates) ====================
  {
    ...
    substrateType: 'paper' as const,
    supportsRecolor: false,
    displacementIntensity: 4,
  },
  {
    id: 'box',
    name: 'Mailer Box',
  ...
  },
  {
    ...
    substrateType: 'cylindrical' as const,
    supportsRecolor: false,
    cylindricalRadius: 40,
    displacementIntensity: 0,
  },
  {
    id: 'beer_bottle',
  ...
  // ==================== 3D CLAY DEVICES (8 templates) ====================
  {
    id: 'clay_iphone16_front',
    name: 'iPhone 16 Pro Clay',
    category: '3D Clay Devices',
    bg: 'https://images.unsplash.com/photo-1510557880182-3d4d3cba35a5?auto=format&fit=crop&w=600&q=80',
    defaultPlacement: defPlace(12, 15, 70, 0, 0, 0, 1, 'source-over'),
    tags: ['clay', 'iphone', '3d', 'device', 'app'],
    substrateType: 'device' as const,
    supportsRecolor: false,
    displacementIntensity: 0,
    placementZones: ['full_device'],
  },
  {
    id: 'clay_macbook_float',
    name: 'MacBook Air Floating',
    category: '3D Clay Devices',
    bg: 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&w=600&q=80',
    defaultPlacement: defPlace(14, 18, 64, 0, 0, 0, 1, 'source-over'),
    tags: ['clay', 'macbook', '3d', 'laptop', 'saas'],
    substrateType: 'device' as const,
    supportsRecolor: false,
    displacementIntensity: 0,
    placementZones: ['full_device'],
  ...
  {
    id: 'clay_ipad_flat',
    name: 'iPad Pro Flat Lay',
    category: '3D Clay Devices',
    bg: 'https://images.unsplash.com/photo-1544816155-12df9643f363?auto=format&fit=crop&w=600&q=80',
    defaultPlacement: defPlace(10, 20, 60, 0, 0, 0, 1, 'source-over'),
    tags: ['clay', 'ipad', '3d', 'tablet'],
    substrateType: 'device' as const,
    supportsRecolor: false,
    displacementIntensity: 0,
    placementZones: ['full_device'],
  ...
  {
    id: 'clay_android_phone',
    name: 'Android Clay Phone',
    category: '3D Clay Devices',
    bg: 'https://images.unsplash.com/photo-1598327105666-5b89351aff23?auto=format&fit=crop&w=600&q=80',
    defaultPlacement: defPlace(12, 16, 68, 0, 0, 0, 1, 'source-over'),
    tags: ['clay', 'android', '3d', 'phone'],
    substrateType: 'device' as const,
    supportsRecolor: false,
    displacementIntensity: 0,
    placementZones: ['full_device'],
  ...
  {
    id: 'clay_monitor_curved',
    name: 'Curved Monitor Clay',
    category: '3D Clay Devices',
    bg: 'https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?auto=format&fit=crop&w=600&q=80',
    defaultPlacement: defPlace(8, 10, 80, 0, 0, 0, 1, 'source-over'),
    tags: ['clay', 'monitor', '3d', 'desktop', 'dashboard'],
    substrateType: 'device' as const,
    supportsRecolor: false,
    displacementIntensity: 0,
    placementZones: ['full_device'],
  ...
  {
    id: 'clay_watch',
    name: 'Apple Watch Clay',
    category: '3D Clay Devices',
    bg: 'https://images.unsplash.com/photo-1579586337278-3befd40fd17a?auto=format&fit=crop&w=600&q=80',
    defaultPlacement: defPlace(18, 28, 44, 0, 0, 0, 1, 'source-over'),
    tags: ['clay', 'watch', '3d', 'wearable'],
    substrateType: 'device' as const,
    supportsRecolor: false,
    displacementIntensity: 0,
    placementZones: ['full_device'],
  ...
  {
    id: 'clay_macbook_isometric',
    name: 'MacBook Isometric Clay',
    category: '3D Clay Devices',
    bg: 'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?auto=format&fit=crop&w=600&q=80',
    defaultPlacement: defPlace(20, 22, 56, 0, 0, 8, 1, 'source-over'),
    tags: ['clay', 'macbook', '3d', 'isometric'],
    substrateType: 'device' as const,
    supportsRecolor: false,
    displacementIntensity: 0,
    placementZones: ['full_device'],
  ...
  {
    id: 'clay_phone_mockup_angled',
    name: 'Phone Angled 3/4 Clay',
    category: '3D Clay Devices',
    bg: 'https://images.unsplash.com/photo-1592750475338-74b7b21085ab?auto=format&fit=crop&w=600&q=80',
    defaultPlacement: defPlace(10, 18, 65, 0, 0, 0, 1, 'source-over'),
    tags: ['clay', 'phone', '3d', 'angled'],
    substrateType: 'device' as const,
    supportsRecolor: false,
    displacementIntensity: 0,
    placementZones: ['full_device'],
  ...
  // ==================== STREETWEAR (6 templates) ====================
  {
    id: 'boxy_tee_front',
    name: 'Oversized Boxy Tee — Front',
    category: 'Streetwear',
    bg: 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=600&q=80',
    defaultPlacement: defPlace(22, 26, 48),
    tags: ['streetwear', 'oversized', 'tee', 'boxy', 'front', 'hypebeast'],
    substrateType: 'fabric' as const,
    supportsRecolor: true,
    displacementIntensity: 14,
    placementZones: ['center_hero', 'oversized_streetwear', 'left_chest'],
  },
  {
    id: 'boxy_tee_back',
    name: 'Oversized Boxy Tee — Back',
    category: 'Streetwear',
    bg: 'https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?auto=format&fit=crop&w=600&q=80',
    defaultPlacement: defPlace(18, 24, 52),
    tags: ['streetwear', 'oversized', 'tee', 'back', 'full back print'],
    substrateType: 'fabric' as const,
    supportsRecolor: true,
    displacementIntensity: 14,
    placementZones: ['center_hero', 'oversized_streetwear'],
  },
  {
    ...
    category: 'Streetwear',
    bg: 'https://images.unsplash.com/photo-1556821840-3a63f95609a7?auto=format&fit=crop&w=600&q=80',
    defaultPlacement: defPlace(25, 28, 44),
    tags: ['streetwear', 'hoodie', 'heavyweight', 'hypebeast'],
    substrateType: 'fabric' as const,
    supportsRecolor: true,
    displacementIntensity: 16,
    placementZones: ['center_hero', 'oversized_streetwear', 'left_chest'],
  },
  {
    id: 'fleece_quarterzip',
    name: 'Fleece Quarter-Zip',
    category: 'Streetwear',
    bg: 'https://images.unsplash.com/photo-1614975058789-41316d0e2e9c?auto=format&fit=crop&w=600&q=80',
    defaultPlacement: defPlace(24, 30, 40),
    tags: ['streetwear', 'fleece', 'quarter-zip', 'athletic'],
    substrateType: 'fabric' as const,
    supportsRecolor: true,
    displacementIntensity: 10,
    placementZones: ['center_hero', 'left_chest'],
  },
  {
    id: 'trucker_hat_6panel',
    name: '6-Panel Trucker Hat',
    category: 'Streetwear',
    bg: 'https://images.unsplash.com/photo-1588850561407-ed78c282e89b?auto=format&fit=crop&w=600&q=80',
    defaultPlacement: defPlace(34, 36, 28, 0, 0, 0, 0.9, 'multiply'),
    tags: ['streetwear', 'hat', 'trucker', 'cap', 'front patch'],
    substrateType: 'fabric' as const,
    supportsRecolor: true,
    displacementIntensity: 5,
    placementZones: ['left_chest'],
  },
  {
    id: 'enamel_pin_jacket',
    name: 'Enamel Pin on Denim Jacket',
    category: 'Streetwear',
    bg: 'https://images.unsplash.com/photo-1576871337622-98d48d1cf531?auto=format&fit=crop&w=600&q=80',
    defaultPlacement: defPlace(30, 28, 18, 0, 0, 0, 0.9, 'multiply'),
    tags: ['streetwear', 'enamel', 'pin', 'denim', 'patch'],
    substrateType: 'fabric' as const,
    supportsRecolor: false,
    displacementIntensity: 4,
    placementZones: ['left_chest', 'sleeve_patch'],
  },

  // ==================== SUSTAINABLE PACKAGING (6 templates) ====================
  {
    id: 'standup_pouch_kraft',
    name: 'Matte Stand-Up Kraft Pouch',
    category: 'Sustainable Packaging',
    bg: 'https://images.unsplash.com/photo-1559526323-cb2f2fe2591b?auto=format&fit=crop&w=600&q=80',
    defaultPlacement: defPlace(18, 32, 36, 0, 0, 5, 0.9, 'multiply'),
    tags: ['kraft', 'pouch', 'eco', 'sustainable', 'coffee', 'food'],
    substrateType: 'paper' as const,
    supportsRecolor: true,
    displacementIntensity: 5,
    placementZones: ['center_hero'],
  },
  {
    ...
    category: 'Sustainable Packaging',
    bg: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=600&q=80',
    defaultPlacement: defPlace(22, 30, 40, 0, 0, 0, 0.9, 'multiply'),
    tags: ['kraft', 'paper bag', 'eco', 'sustainable', 'shopping'],
    substrateType: 'paper' as const,
    supportsRecolor: true,
    displacementIntensity: 4,
    placementZones: ['center_hero'],
  ...
  {
    id: 'bamboo_cosmetic_jar',
    name: 'Bamboo Cosmetic Jar',
    category: 'Sustainable Packaging',
    bg: 'https://images.unsplash.com/photo-1620916566398-39f1143ab7be?auto=format&fit=crop&w=600&q=80',
    defaultPlacement: defPlace(38, 42, 16, 0, 0, 0, 0.85, 'multiply'),
    tags: ['bamboo', 'cosmetic', 'jar', 'eco', 'beauty', 'skincare'],
    substrateType: 'cylindrical' as const,
    supportsRecolor: false,
    cylindricalRadius: 35,
    displacementIntensity: 0,
    placementZones: ['center_hero'],
  },
  {
    id: 'recycled_card_box',
    name: 'Recycled Card Box',
    category: 'Sustainable Packaging',
    bg: 'https://images.unsplash.com/photo-1586769852044-692d6e3703f0?auto=format&fit=crop&w=600&q=80',
    defaultPlacement: defPlace(28, 26, 48, 0, 0, 0, 0.9, 'multiply'),
    tags: ['recycled', 'cardboard', 'box', 'eco', 'mailer'],
    substrateType: 'paper' as const,
    supportsRecolor: true,
  ...
  {
    id: 'seed_packet',
    name: 'Eco Seed Packet',
    category: 'Sustainable Packaging',
    bg: 'https://images.unsplash.com/photo-1585553616435-2dc0a54e271d?auto=format&fit=crop&w=600&q=80',
    defaultPlacement: defPlace(20, 30, 40, 0, 0, 0, 0.9, 'multiply'),
    tags: ['seed', 'packet', 'eco', 'garden', 'natural'],
    substrateType: 'paper' as const,
    supportsRecolor: true,
    displacementIntensity: 3,
    placementZones: ['center_hero'],
  ...
  {
    id: 'paper_tape_roll',
    name: 'Paper Tape Roll',
    category: 'Sustainable Packaging',
    bg: 'https://images.unsplash.com/photo-1563986768609-322da13575f3?auto=format&fit=crop&w=600&q=80',
    defaultPlacement: defPlace(30, 35, 30, 0, 0, 0, 0.85, 'multiply'),
    tags: ['tape', 'roll', 'packaging', 'eco', 'stationery'],
    substrateType: 'paper' as const,
    supportsRecolor: false,
    displacementIntensity: 2,
  },
];
...
// ==================== STREETWEAR (6 templates) ====================
// ==================== SUSTAINABLE PACKAGING (6 templates) ====================
// (appended via Pillar 4 — 2026 Trending Mockup Library)
