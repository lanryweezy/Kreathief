...
const RESIZE_TARGETS: ResizeTarget[] = [
  { name: 'Instagram Post', width: 1080, height: 1080, platform: 'Instagram', icon: 'Camera' },
  { name: 'Instagram Story', width: 1080, height: 1920, platform: 'Instagram', icon: 'Smartphone' },
  { name: 'Instagram Reel', width: 1080, height: 1920, platform: 'Instagram', icon: 'Play' },
  { name: 'Twitter/X Post', width: 1200, height: 675, platform: 'Twitter', icon: 'Twitter' },
  { name: 'Twitter/X Header', width: 1500, height: 500, platform: 'Twitter', icon: 'Twitter' },
  ...
  { name: 'LinkedIn Post', width: 1200, height: 627, platform: 'LinkedIn', icon: 'Linkedin' },
  { name: 'LinkedIn Banner', width: 1584, height: 396, platform: 'LinkedIn', icon: 'Linkedin' },
  { name: 'YouTube Thumbnail', width: 1280, height: 720, platform: 'YouTube', icon: 'Youtube' },
  { name: 'YouTube Banner', width: 2560, height: 1440, platform: 'YouTube', icon: 'Youtube' },
  { name: 'TikTok', width: 1080, height: 1920, platform: 'TikTok', icon: 'Smartphone' },
  { name: 'Pinterest Pin', width: 1000, height: 1500, platform: 'Pinterest', icon: 'Pin' },
  { name: 'Pinterest Board', width: 1000, height: 1000, platform: 'Pinterest', icon: 'Pin' },
  { name: 'Email Header', width: 600, height: 200, platform: 'Email', icon: 'FileText' },
  { name: 'Presentation 16:9', width: 1920, height: 1080, platform: 'Slides', icon: 'Layout' },
  { name: 'Presentation 4:3', width: 1024, height: 768, platform: 'Slides', icon: 'Layout' },
  { name: 'Business Card', width: 1050, height: 600, platform: 'Print', icon: 'CreditCard' },
  { name: 'A4 Poster', width: 2480, height: 3508, platform: 'Print', icon: 'FileText' },
  { name: 'HD Wallpaper', width: 1920, height: 1080, platform: 'Desktop', icon: 'Monitor' },
  { name: '4K Wallpaper', width: 3840, height: 2160, platform: 'Desktop', icon: 'Monitor' },
];
