...
const App: React.FC = () => {
  ...
  const [activeTour, setActiveTour] = useState<"dashboard" | "editor" | null>(
    null,
  );
  ...
  useEffect(() => {
    ...
    const timeout = setTimeout(() => {
      ...
      storageService.saveSessionMirror(
        state.projectId,
        mirrorState as any,
        state.past,
        state.future,
  ...
  const dashboardTourSteps: TourStep[] = [
    {
      ...
      title: "Start Fresh",
      content:
        "Click here to start a blank canvas and let your creativity flow.",
      position: "bottom",
    },
    {
  ...
  const editorTourSteps: TourStep[] = [
    ...
    },
    {
      ...
      title: "The Canvas",
      content:
        "This is where you create. Drag and drop elements, or use the brush to draw.",
      position: "right",
    },
    {
    ...
    },
    {
      ...
      title: "Export",
      content:
        "Ready to share? Export your design in high quality PNG, JPG, or WEBP.",
      position: "bottom",
    },
  ];
