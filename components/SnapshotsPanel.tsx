        ...
        <div className="h-full flex flex-col bg-slate-900 text-white">
            <div className="p-4 border-b border-slate-700">
                ...
                <p className="text-xs text-slate-400 mt-1">
                    Save checkpoints of your design to restore later.
                </p>
            </div>
            ...
            <div className="p-4 border-b border-slate-700 bg-slate-800/50">
                <div className="flex gap-2">
                    ...
                    >
                        {isCreating ? <span className="animate-spin inline-block">⌛</span> : <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>}
                    </button>
                </div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3 custom-scrollbar">
                {snapshots.length === 0 ? (
                    <div className="text-center text-slate-500 py-8 flex flex-col items-center">
                        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mb-2 opacity-50"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"></path><circle cx="12" cy="13" r="4"></circle></svg>
                        <p>No snapshots yet.</p>
                        <p className="text-xs">Create one to save your progress.</p>
                    </div>
                ) : (
                    snapshots.map((snapshot) => (
                        <div key={snapshot.id} className="bg-slate-800 rounded-lg p-3 border border-slate-700 hover:border-slate-600 transition-colors group">
