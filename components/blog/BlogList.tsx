...
export const BlogList: React.FC = () => {
  return (
    <div className="min-h-screen bg-surface-dark-0 text-white selection:bg-brand-600 pt-32 pb-20">
      <SEO
          ...
          {BLOG_POSTS.map((post) => (
            ...
            >
              ...
              <div className="p-8">
                ...
                <p className="text-gray-400 line-clamp-2 leading-relaxed mb-6">{post.excerpt}</p>
