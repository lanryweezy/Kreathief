      ...
      <div className="w-full max-w-md p-8 bg-[#1e1e1e]/80 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl relative z-10">
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-[#1e1e1e]/80 px-2 text-gray-500">Or continue with</span>
          </div>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full bg-[#13161a] hover:bg-[#1a1d21] border border-gray-700 rounded-lg py-3 px-4 text-white font-medium transition-all flex items-center justify-center gap-3 disabled:opacity-50"
        >
