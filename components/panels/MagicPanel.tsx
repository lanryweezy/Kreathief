  ...
  return (
    <div className="flex flex-col h-full bg-surface-dark-2 overflow-hidden">
      <PanelHeader
        ...
        activeTabId={mode}
        onTabChange={(id) => onSetMode(id as AppMode)}
      />
      <div className="flex-1 overflow-y-auto custom-scrollbar flex flex-col">
        ...
        <div className="p-4 border-t border-white/5">
          <h4 className="text-[9px] font-black text-gray-500 uppercase tracking-widest mb-4 sticky top-0 bg-surface-dark-2 py-2 z-10">
            Curated Styles
          </h4>
