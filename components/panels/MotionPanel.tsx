...
import { Layer, AnimationSettings, TextLayer, ShapeLayer, ImageLayer } from '../../types';
                ...
                <div className="grid grid-cols-3 gap-2">
                    {ANIMATION_TYPES.map((t) => (
                        <button
                            ...
                            className={`flex flex-col items-center justify-center p-3 rounded-lg border transition-all aspect-square ${anim.type === t.type
