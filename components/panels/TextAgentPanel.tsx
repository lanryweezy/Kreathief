  ...
  if (!selectedLayer) {
    return (
      <div className="bg-surface-dark-3 rounded-xl border border-gray-700 p-4">
        ...
        <p className="text-[10px] text-gray-500 text-center py-4">Select a text layer to use AI typography & rewrite tools</p>
      </div>
    );
  }
      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <Button
            ...
            size="sm"
            className="w-full text-[10px] justify-start py-2 h-auto flex items-center gap-2"
            onClick={() => handleToneRewrite(selectedLayer.id, 'Rewrite this for an African/Nigerian demographic using local contextual slang (Naija) but keeping it premium.')}
            disabled={disableTools}
          >
      ...
      <div className="space-y-2 pt-2 border-t border-gray-700">
        ...
        <div className="grid grid-cols-2 gap-2">
           <Button
            ...
            size="sm"
            className="w-full text-[10px] justify-start py-2 h-auto flex items-center gap-2"
            onClick={() => handleToneRewrite(selectedLayer.id, 'Fix all grammar and spelling mistakes. Do not change the length significantly.')}
            disabled={disableTools}
          >
