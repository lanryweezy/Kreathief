...
const INTENTS: IntentCard[] = [
  { id: 'social', title: 'Social Post', description: 'Square format for Instagram, Facebook', width: 1080, height: 1080, icon: Icons.Share2 },
  { id: 'flyer', title: 'Flyer', description: 'Standard 8.5 × 11 inch print', width: 2550, height: 3300, icon: Icons.FileText },
  { id: 'presentation', title: 'Presentation', description: 'Widescreen 16:9 slides', width: 1920, height: 1080, icon: Icons.Monitor },
  { id: 'brand-kit', title: 'Brand Kit', description: 'Colors, fonts & logo system', width: 1080, height: 1080, icon: Icons.Palette },
  { id: 'logo', title: 'Logo', description: 'Square logo at 1024px', width: 1024, height: 1024, icon: Icons.Hexagon },
  { id: 'youtube', title: 'YouTube Thumbnail', description: 'Optimized for YouTube (1280×720)', width: 1280, height: 720, icon: Icons.Youtube },
  { id: 'mockup', title: 'Product Mockup', description: 'Custom size for product visuals', width: 1200, height: 1200, icon: Icons.Box },
  { id: 'website', title: 'Website Hero', description: 'Full-width hero banner (1920×1080)', width: 1920, height: 1080, icon: Icons.Globe },
  { id: 'business-card', title: 'Business Card', description: 'Standard 3.5 × 2 inch card', width: 1050, height: 600, icon: Icons.CreditCard },
  { id: 'poster', title: 'Poster', description: 'Large format 24 × 36 inch', width: 7200, height: 10800, icon: Icons.Image },
];
