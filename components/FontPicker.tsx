...
const FontItem = React.memo(({ font, isSelected, onSelect }: { font: string, isSelected: boolean, onSelect: (f: string) => void }) => {
    ...
    return (
        ...
        >
            ...
            {!isLoaded && (
                <span className="text-xs text-gray-600 absolute top-2 left-3">Loading...</span>
            )}
        </button>
    );
});
