           ...
           {!isFullscreen && (
             ...
             >
                      ...
                      <div className="flex flex-col gap-1">
                        {itemKeys.map((key) => {
                          ...
                          return (
                            ...
                            >
                              <item.icon className={`w-3.5 h-3.5 transition-all ${isActive ? 'scale-110 opacity-100' : 'opacity-50 group-hover:opacity-100 group-hover:scale-110'}`} />
                ...
                <div className="mt-8 pt-6 border-t border-white/5">
                   <div className="text-[10px] font-black text-gray-500 uppercase tracking-widest mb-4 px-2">Environment</div>
                ...
                <div className="mt-6 pt-6 border-t border-white/5">
                   <div className="flex items-center justify-between px-2">
                      ...
                      >
                         <div className={`absolute top-1 w-3 h-3 bg-white rounded-full transition-all ${useDisplacement ? 'left-6' : 'left-1'}`} />
                      </button>
                   </div>
                </div>
