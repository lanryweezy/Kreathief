...
export const AssetUploadModal: React.FC<AssetUploadModalProps> = React.memo(function AssetUploadModal({
  isOpen,
  onClose,
}) {
  ...
  const selectClass =
    'w-full px-3 py-2 text-sm rounded-xl bg-surface-dark-3 text-white border border-white/10 hover:border-white/20 focus:outline-none focus:ring-2 focus:ring-brand-400/50 focus:border-brand-600 transition-all duration-200';
      ...
      <div className="p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <Input
            ...
            placeholder="minimal, modern, template"
            aria-label="Tags"
          />
          <Input
            label="Price ($)"
