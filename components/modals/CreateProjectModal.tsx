        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="bg-[#1e1e1e] border border-gray-700/50 rounded-3xl w-full max-w-3xl overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.5)] animate-scaleIn relative z-10 border-t-white/10">
                <div className="p-6 border-b border-gray-800 flex justify-between items-center bg-gradient-to-r from-[#252627] to-[#1e1e1e]">
                    ...
                    <button onClick={onClose} className="text-gray-500 hover:text-white p-2 hover:bg-white/5 rounded-full transition-all">
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex flex-col text-left">
                                            ...
                                            <span className="text-[10px] text-gray-500 font-medium">{size.width} × {size.height} px</span>
                                        </div>
                                    </div>
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex-1 flex flex-col justify-between bg-[#13161a]/50 p-7 rounded-3xl border border-gray-800 backdrop-blur-sm shadow-inner">
                            <div className="space-y-6">
                                <div className="group">
                                    <label className="text-[10px] font-black text-gray-500 uppercase mb-2 block tracking-wider group-focus-within:text-[#7d2ae8] transition-colors">Design Name</label>
                                ...
                                <div className="grid grid-cols-2 gap-5">
                                    <div className="group">
                                        <label className="text-[10px] font-black text-gray-500 uppercase mb-2 block tracking-wider group-focus-within:text-[#7d2ae8] transition-colors">Width (px)</label>
                                        <input
                                            type="number"
                                            value={customWidth}
                                    ...
                                    <div className="group">
                                        <label className="text-[10px] font-black text-gray-500 uppercase mb-2 block tracking-wider group-focus-within:text-[#7d2ae8] transition-colors">Height (px)</label>
                                        <input
                                            type="number"
                                            value={customHeight}
