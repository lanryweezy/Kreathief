    ...
    <ModalWrapper isOpen={isOpen} onClose={onClose} maxWidth="max-w-2xl">
      <div className="flex flex-col relative">
        <div className="p-10 pb-4 text-center">
          ...
          <h2 className="text-4xl font-black text-white mb-3 tracking-tighter italic uppercase">Welcome to Kreathief</h2>
        ...
        <div className="p-10 grid grid-cols-1 md:grid-cols-2 gap-4">
          {[
            { icon: Icons.Magic, title: 'AI Generation', desc: 'Text-to-design in seconds.', color: 'text-[#00c4cc]', bg: 'bg-[#00c4cc]/10' },
            { icon: Icons.Layers, title: 'Pro Engine', desc: 'Layered control & masking.', color: 'text-[#7d2ae8]', bg: 'bg-[#7d2ae8]/10' },
            { icon: Icons.Search, title: 'AI Assistant', desc: 'Collaborative logic traces.', color: 'text-indigo-400', bg: 'bg-indigo-400/10' },
            { icon: Icons.Mockup, title: 'Mockup Studio', desc: 'Real-world 3D previews.', color: 'text-emerald-400', bg: 'bg-emerald-400/10' },
          ].map((feature, i) => (
            <div key={i} className="p-5 bg-white/5 border border-white/5 rounded-2xl hover:border-white/10 hover:bg-white/10 transition-all group">
