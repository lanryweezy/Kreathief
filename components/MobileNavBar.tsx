            ...
            >
              <div
                className={`
                            ...
                            `}
              >
                <Icon className={`w-5 h-5 ${isActive ? 'text-white drop-shadow-lg' : ''}`} aria-hidden="true" />
              </div>
              <span
                className={`
              ...
              {isActive && <div className="absolute -top-1 w-1 h-1 bg-white rounded-full animate-pulse" />}
            </button>
          );
        })}
      </div>
