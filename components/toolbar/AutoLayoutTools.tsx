...
export const AutoLayoutTools = React.memo(({ selectedLayer, handleUpdateLayer }: AutoLayoutToolsProps) => {
  ...
  return (
    <div className="flex items-center gap-1">
      <IconButton onClick={toggleAutoLayout} active={isAutoLayout} title="Toggle Auto-Layout">
        <Icons.Layout className="w-3.5 h-3.5" />
      </IconButton>

      {isAutoLayout && (
        <div className="relative">
          <IconButton ref={buttonRef} onClick={() => setShowDropdown(!showDropdown)} title="Auto-Layout Settings">
