...
export const TemplateGallery: React.FC<{ onGetStarted?: () => void }> = ({ onGetStarted }) => {
  const templates = [
    // Original Templates
    { id: 1, src: '/images/template_thumb_1_1772615134954.webp', style: 'md:col-span-1 md:row-span-2' },
    { id: 2, src: '/images/template_thumb_2_1772615154321.webp', style: 'md:col-span-1 md:row-span-1' },
    { id: 3, src: '/images/template_thumb_3_1772615229047.webp', style: 'md:col-span-1 md:row-span-1' },
    { id: 4, src: '/images/template_thumb_4_1772615492900.webp', style: 'md:col-span-1 md:row-span-2' },
    { id: 5, src: '/images/template_thumb_5_1772615512770.webp', style: 'md:col-span-2 md:row-span-1' },
    { id: 6, src: '/images/template_thumb_6_1772615671327.webp', style: 'md:col-span-1 md:row-span-1' },

    // New Templates
    { id: 7, src: '/images/template_cyberpunk.webp', style: 'md:col-span-1 md:row-span-2' },
    { id: 8, src: '/images/template_minimalist.webp', style: 'md:col-span-1 md:row-span-1' },
    { id: 9, src: '/images/template_abstract.webp', style: 'md:col-span-1 md:row-span-1' },
    { id: 10, src: '/images/template_retro.webp', style: 'md:col-span-1 md:row-span-2' },
    { id: 11, src: '/images/template_fashion.webp', style: 'md:col-span-2 md:row-span-1' },
    { id: 12, src: '/images/template_hitech.webp', style: 'md:col-span-1 md:row-span-1' },
    { id: 13, src: '/images/template_cute.webp', style: 'md:col-span-1 md:row-span-1' },

    // Requested by User
    { id: 14, src: '/images/template_business.webp', style: 'md:col-span-1 md:row-span-2' },
    { id: 15, src: '/images/template_church.webp', style: 'md:col-span-1 md:row-span-1' },
    { id: 16, src: '/images/template_club.webp', style: 'md:col-span-2 md:row-span-1' },
  ];
