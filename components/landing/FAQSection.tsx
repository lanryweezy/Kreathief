...
const faqs = [
    {
        ...
        answer: "Unlike traditional vector editors that require manual path manipulation, Kreathief is a completely AI-Native design platform. It embeds generative diffusion models directly into the WebGL canvas, allowing you to construct complex vector SVGs, high-fidelity UI mockups, and layouts instantly via natural language, while still retaining absolute layer-level control."
    },
    {
        question: "Can I use Kreathief for commercial enterprise projects?",
        answer: "Yes, absolutely. All graphic assets, typography styles, and vector paths generated and refined within the Kreathief studio grant you full, unencumbered commercial usage rights. Whether you are an independent freelancer or an enterprise marketing team, you own your exports forever."
    },
    {
        question: "What high-resolution export formats are currently supported?",
        answer: "We support loss-less, high-fidelity exports across all industry standard formats. This includes infinite-resolution SVG, 8K uncompressed PNG, highly optimized WEBP for web performance, and print-ready PDF. There are never any watermarks or hidden export fees."
    },
    {
        question: "Does the platform support real-time multiplayer collaboration?",
        answer: "Yes! Kreathief features robust native multiplayer capabilities synchronized via edge-network WebSockets. Multiple designers, copywriters, and stakeholders can inhabit the identical canvas, viewing live cursors and generative edits in literal real-time without polling delays or sync conflicts."
    },
    {
                ...
                <div className="space-y-4">
                    {faqs.map((faq, idx) => (
                        <motion.div 
                            ...
                            key={idx} 
                            className="bg-[#0a0a0a] border border-white/5 rounded-2xl overflow-hidden hover:border-purple-500/30 transition-colors"
                        >
                            <button 
                            ...
                            >
                                ...
                                <div className={`w-8 h-8 rounded-full flex items-center justify-center transition-transform duration-300 ${openIndex === idx ? 'bg-purple-500 rotate-180' : 'bg-white/5'}`}>
