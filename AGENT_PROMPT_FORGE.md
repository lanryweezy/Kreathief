...
CRITIC DECISIONS:
  ...
  → CONDITIONAL PASS — Critic applies specific automated fixes:
    - Contrast fix: adjust text colour to pass WCAG AA
    - Spacing fix: add minimum margin to edge-touching elements
    - Label fix: replace generic placeholder labels with descriptive ones
