...
test('Verbose Test: Design Agent with Bottleneck Profiling', async ({ page }) => {
  ...
  await page.screenshot({ path: `C:/Users/USER/.gemini/antigravity-ide/brain/8643b4c2-fa0b-4d3e-8ce5-6501c7f1cd5a/step_1_empty_editor.png` });
  ...
  await page.screenshot({ path: `C:/Users/USER/.gemini/antigravity-ide/brain/8643b4c2-fa0b-4d3e-8ce5-6501c7f1cd5a/step_2_ai_panel_open.png` });

  const prompts = [
    "minimalist tech startup conference banner",
    "vibrant tropical summer party invitation"
  ];
  ...
  for (let i = 0; i < prompts.length; i++) {
    ...
    if (await targetInput.isVisible()) {
      ...
      await page.screenshot({ path: `C:/Users/USER/.gemini/antigravity-ide/brain/8643b4c2-fa0b-4d3e-8ce5-6501c7f1cd5a/step_3_prompt_typed_${i}.png` });
      ...
      await page.screenshot({ path: `C:/Users/USER/.gemini/antigravity-ide/brain/8643b4c2-fa0b-4d3e-8ce5-6501c7f1cd5a/step_4_generating_${i}.png` });
      
      console.log(`Waiting for generation to finish...`);
      try {
        await page.waitForSelector('button:has-text("Apply This Variant"), button:has-text("Apply this variant")', { timeout: 90000 });
      ...
      await page.screenshot({ path: `C:/Users/USER/.gemini/antigravity-ide/brain/8643b4c2-fa0b-4d3e-8ce5-6501c7f1cd5a/step_5_variants_ready_${i}.png` });
      ...
      if (await applyBtn.isVisible()) {
        ...
        await page.screenshot({ path: `C:/Users/USER/.gemini/antigravity-ide/brain/8643b4c2-fa0b-4d3e-8ce5-6501c7f1cd5a/step_6_applied_design_${i}.png` });
      }
    }
  }
});
