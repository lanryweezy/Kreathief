...
function generateCurves(n: number): Float64Array {
  ...
  for (let i = 0; i < n; i++) {
    const base = i * 8;
    buf[base] = Math.random() * 1000;
    buf[base + 1] = Math.random() * 1000;
    buf[base + 2] = Math.random() * 1000;
    buf[base + 3] = Math.random() * 1000;
    buf[base + 4] = Math.random() * 1000;
    buf[base + 5] = Math.random() * 1000;
    buf[base + 6] = Math.random() * 1000;
    buf[base + 7] = Math.random() * 1000;
  }
  return buf;
}
...
async function main() {
  ...
  console.log('');
  const t5 = bench(
    'JS   pointOnCurve x100',
    () => {
      for (const c of jsCurves100) jsPOC(c[0], c[1], c[2], c[3], 0.5);
    },
    50000
  );
  ...
  const t7 = bench(
    'JS   pointOnCurve x1000',
    () => {
      for (const c of jsCurves1000) jsPOC(c[0], c[1], c[2], c[3], 0.5);
    },
    50000
  );
  ...
  const t9 = bench(
    'JS   curveLength x100',
    () => {
      for (const c of jsCurves100) jsCL(c[0], c[1], c[2], c[3], 32);
    },
    50000
  );
  ...
  const t11 = bench(
    'JS   curveLength x1000',
    () => {
      for (const c of jsCurves1000) jsCL(c[0], c[1], c[2], c[3], 32);
    },
    50000
  );
