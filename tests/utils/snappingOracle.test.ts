...
describe('SnappingOracle', () => {
  ...
  beforeEach(() => {
    ...
    allLayers = [
      ...
      { id: 'l5', x: 700, y: 700, width: 50, height: 50, locked: false, visible: true, groupId: 'g1' } as unknown as Layer, // in group
    ];
  });
  ...
  it('should snap to artboard boundaries', () => {
    ...
    const movingLayer = { id: 'm1', x: 2, y: 500, width: 100, height: 100, locked: false, visible: true } as unknown as Layer;
  ...
  it('should snap to other layer edges (left edge to right edge)', () => {
    ...
    const movingLayer = { id: 'm1', x: 302, y: 500, width: 100, height: 100, locked: false, visible: true } as unknown as Layer;
  ...
  it('should snap y to other layer edges', () => {
    ...
    const movingLayer = { id: 'm1', x: 500, y: 298, width: 100, height: 100, locked: false, visible: true } as unknown as Layer;
  ...
  it('should not snap to locked, hidden, or grouped layers', () => {
    ...
    const movingLayer1 = { id: 'm1', x: 798, y: 100, width: 100, height: 100, locked: false, visible: true } as unknown as Layer;
    // For l4 (hidden): 900 left edge.
    const movingLayer2 = { id: 'm2', x: 898, y: 100, width: 100, height: 100, locked: false, visible: true } as unknown as Layer;
    // For l5 (grouped): 700 left edge.
    const movingLayer3 = { id: 'm3', x: 698, y: 100, width: 100, height: 100, locked: false, visible: true } as unknown as Layer;
  ...
  it('should adjust threshold based on zoom', () => {
    ...
    const movingLayer = { id: 'm1', x: 4, y: 500, width: 100, height: 100, locked: false, visible: true } as unknown as Layer;
