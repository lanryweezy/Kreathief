export const twitterLaunchThread = [
  {
    ...
    type: "hook",
    content:
      'I built an AI design tool for Africa. Here\'s why. 🧵',
  },
  {
    id: 2,
    type: "problem",
  ...
  },
  {
    ...
    type: "demo",
    content:
      "[Insert GIF/video of Kreathief in action — AI generating a social media post in seconds]",
  },
  {
    id: 7,
    type: "lessons",
...
export const instagramPosts: InstagramPost[] = [
  {
    ...
    visualDescription:
      "Carousel: 3-4 slides showing before/after AI-generated African-themed designs",
  },
  {
    id: 2,
    ...
    visualDescription:
      "Photo/video of workspace, code on screen, team working",
  },
  {
    id: 3,
    ...
    visualDescription:
      "Screenshot of creator's earnings dashboard with their permission, or photo of creator",
  },
  {
    id: 4,
    ...
    visualDescription:
      "Reel/screen recording showing prompt input → AI-generated design result",
  },
  {
    id: 5,
    ...
    visualDescription:
      "Collage of community member profiles, designs, or a map showing creator locations",
  },
];
